...
class BezierDialogPanel(BasePanel):
    def __init__(self, frame: BaseFrame, *args, **kw):
        ...
        self.slider = FloatSliderCtrl(
            parent=self,
            value=0,
            min_value=self.frame.condition_ctrl.min_ctrl.GetValue(),
            max_value=self.frame.condition_ctrl.max_ctrl.GetValue(),
            increment=0.01,
            spin_increment=0.01,
            border=3,
            size=wx.Size(200, -1),
        ...
        self.root_sizer.Add(self.slider.sizer, 0, wx.ALL, 3)
