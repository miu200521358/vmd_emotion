...
class MorphCtrlSet:
    def __init__(
        ...
        self.blink_morph_ctrl = MorphReplaceSet(self.panel, self.window, self)
        self.sizer.Add(self.blink_morph_ctrl.sizer, 0, wx.ALL, 3)

        self.smile_morph_ctrl = MorphReplaceSet(self.panel, self.window, self)
    ...
    def Enable(self, enable: bool) -> None:
        ...
        self.async_sub_window_btn.Enable(enable)
