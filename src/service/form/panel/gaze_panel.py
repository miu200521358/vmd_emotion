...
class GazePanel(ServicePanel):
    ...
    def _initialize_service_ui(self) -> None:
        ...
        self.gaze_title_ctrl = wx.StaticText(self.scrolled_window, wx.ID_ANY, __("目線生成パラメーター: "), wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.gaze_limit_lower_x_ctrl = WheelSpinCtrl(self.scrolled_window, initial=-7, min=-45, max=0, size=wx.Size(60, -1))
        ...
        self.gaze_limit_upper_y_ctrl = WheelSpinCtrl(self.scrolled_window, initial=12, min=0, max=45, size=wx.Size(60, -1))
        ...
        self.gaze_limit_lower_y_ctrl = WheelSpinCtrl(self.scrolled_window, initial=-12, min=-45, max=0, size=wx.Size(60, -1))
        ...
        self.gaze_reset_ctrl = WheelSpinCtrl(self.scrolled_window, initial=8, min=5, max=15, size=wx.Size(60, -1))
